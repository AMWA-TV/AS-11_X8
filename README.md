# **[Work In Progress]** AS-11 X8 (MXF Program Contribution - NABA HD (MPEG-2))

This repository contains the full details of this AMWA Specification. For the latest version of this repository please refer to [its GitHub project](https://github.com/AMWA-TV/AS-11_X8/).
...
* Visit the AMWA [web page for the Specification](http://amwa.tv/projects/AS-11-X8.shtml) to view the web page online.
* Alternatively, clone or download this repository and open [AMWA_AS_11_X8.html](AMWA_AS_11_X8.html).
...
The full Specification history is available [here](https://github.com/AMWA-TV/AS-11_X8/commits). It is best to ignore changes to `AMWA_AS_11_X8.html` when examining the history of this repository (all the pertinent changes will be apparent in other files).
